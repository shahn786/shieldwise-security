...
// San Diego County cities data with complete information
const cities = [
    {
        name: 'Escondido',
        slug: 'escondido',
...
<body id="top" class="${city.slug}-page">
    ...
    <!-- Hero Section -->
    <section class="${city.slug}-hero" style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('/img/2.webp');">
        ...
        <div class="${city.slug}-hero-content">
            ...
            <div class="${city.slug}-cta-buttons">
                ...
                <a href="tel:7147167430" class="${city.slug}-cta-button-alt animate-fade-in-delay-2"><i class="fas fa-phone"></i> ${city.phone}</a>
            </div>
        </div>
    </section>
